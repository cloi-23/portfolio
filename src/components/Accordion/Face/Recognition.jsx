...
import KnownFacesList from "./KnownList";
import ThresholdSlider from "./ThresholdSlider";
import loadKnownFaces from "./utils/localKnown";
// import loadFacesFromServer from "./utils/serverKnown";
import TeleportPortal from "../../TeleportPortal";
export default function AccordionFaceRecognition({ darkMode }) {
  ...
  useEffect(() => {
    const localFaces = loadKnownFaces();
    // loadFacesFromServer().then((serverFaces) => {
    // });
    setKnownFaces([...localFaces /* ...serverFaces */]);
  }, []);
  return (
    <div className="w-full flex flex-col items-center">
      ...
      >
        <span className="font-semibold text-5xl">
          {" "}
          <FancyText text="FaceJS" size={200} isHovered={hovered} />
        </span>
        <motion.div
